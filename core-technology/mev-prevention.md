...
This is a pre-public-launch testnet. The development testnet runs 2-second blocks, with 6 seconds as the production-testnet target (tracked in-code as M-19); the mainnet runtime is compiled at 3 seconds. Treat any numbers you measure today as development-configuration numbers. <!-- fact:CC-05,CC-04 -->
